...
if __name__ == '__main__':
    ...
    H_1 = solve_homography(corners1, x)
    H_2 = solve_homography(corners2, x)
    output3_1 = warping(secret1, dst, H_1, 0, h, 0, w, direction='b')
    output3_2 = warping(secret2, dst, H_2, 0, h, 0, w, direction='b')
